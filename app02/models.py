...
class Permission(models.Model):
    ...
    menu = models.ForeignKey(Menu, verbose_name='所属菜单',on_delete=models.CASCADE, related_name='permissions',null=True,blank=True)
...
class Permission2Action2Role(models.Model):
    ...
    权限操作关系表
    """
    permission = models.ForeignKey(Permission,on_delete=models.CASCADE, verbose_name='权限URL', related_name='actions')
